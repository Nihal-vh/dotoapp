...
export function Card({ className, children, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn(
        "rounded-lg border border-zinc-800/80 bg-zinc-900/60 p-4 text-zinc-100 shadow-sm backdrop-blur-sm",
        className
      )}
      {...props}
    >
...
export function CardFooter({ className, children, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div className={cn("flex items-center pt-3 border-t border-zinc-800/60", className)} {...props}>
      {children}
    </div>
  );
}
